...
const ContextExercise = () => {
  ...
  const renderSentenceWithBlank = () => {
    ...
    const selectedWord = selectedId
      ? currentExercise.options.find((o) => o.id === selectedId)
      : null;
    ...
    return (
      <div className="flex flex-wrap items-center justify-center gap-2 text-2xl font-medium text-foreground">
        ...
        >
          <SelectTrigger
            className={`inline-flex h-auto min-w-[140px] max-w-[200px] px-4 py-2 text-xl font-semibold ${getDropdownStyle()}`}
          >
                ...
                <div className="mb-8 overflow-hidden rounded-2xl border border-border bg-card shadow-lg">
                  ...
                  <div className="border-t border-border bg-muted/30 p-4 text-center">
                    <p className="text-sm text-muted-foreground italic">
                      {currentExercise.correctWord.sentenceTranslation.replace(
                        currentExercise.correctWord.definition.toLowerCase(),
                        "___"
                      )}
                    </p>
                  </div>
