...
const generateExercises = (words: typeof mockWords): Exercise[] => {
  ...
  words.forEach((word, index) => {
    ...
    exercises.push({
      ...
      correctWord: word,
      options,
      question: direction === "term-to-definition" ? word.term : word.definition,
    });
  });
...
const TranslationExercise = () => {
  ...
  const getOptionText = (option: Word) => {
    return currentExercise.direction === "term-to-definition"
      ? option.definition
      : option.term;
  };
        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-semibold text-foreground">Translation</h1>
              ...
              >
                ...
                <div className="mb-8 overflow-hidden rounded-2xl border border-border bg-card shadow-lg">
                  <div className="flex flex-col items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10 p-12">
                    <p className="mb-2 text-sm text-muted-foreground">Translate this word:</p>
                  ...
                  {currentExercise.options.map((option) => (
                    ...
                    >
                      ...
                      {answerState !== "unanswered" &&
                        option.id === currentExercise.correctWord.id && (
                        ...
                        {answerState === "correct" ? (
                          ...
                          <>
                            ...
                            <span className="font-semibold">
                              ...
                              {currentExercise.direction === "term-to-definition"
