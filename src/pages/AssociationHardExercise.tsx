...
const generateExercises = (words: typeof mockWords): Exercise[] => {
  return shuffleArray(words).map((word) => ({ word }));
};

const AssociationHardExercise = () => {
              ...
              >
                ...
                <div className="mb-8 overflow-hidden rounded-2xl border border-border bg-card shadow-lg">
                  <div className="relative aspect-video w-full bg-muted">
                    <img
                      src={currentExercise.word.image}
                      alt="What is this?"
                ...
                <div className="mb-6">
                  <Input
                    type="text"
                    placeholder={`Type the word in ${mockDictionary.language}...`}
                    value={userInput}
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="ml-2 rounded-full bg-current/20 px-3 py-1 text-sm font-bold">
...
export default AssociationHardExercise;
