...
import { z } from "zod";
import { BookOpen, Eye, EyeOff, Mail, Lock, User, Check } from "lucide-react";
...
const benefits = [
  "7+ exercise types for comprehensive learning",
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-primary/80 p-12 flex-col justify-between">
        ...
        >
          <h1 className="text-4xl font-bold text-primary-foreground leading-tight">
            Start your vocabulary learning adventure today
          </h1>
          <p className="text-primary-foreground/80 text-lg">
            Join thousands of learners who are expanding their vocabulary with our science-backed methods.
          </p>
        ...
        >
          <Card className="border-0 shadow-lg">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                Start your free vocabulary learning journey
              </CardDescription>
            </CardHeader>
